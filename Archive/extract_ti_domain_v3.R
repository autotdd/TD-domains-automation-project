...
extract_ti_domain <- function(study_id, pdf_path = "protocol.pdf", incl_range = 64:67, excl_range = 67:71, incl_section = "4.1.1", excl_section = "4.1.2") {
...
cat("Please enter the study ID: ")
study_id <- scan(what = "", nmax = 1)
