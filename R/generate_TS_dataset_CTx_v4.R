...
#' @examples
#' generate_TS_dataset_CTx_v4("STUDY123", 5)
#' @export
generate_TS_dataset_CTx_v4 <- function(study_id, num_rows) {
...
# Function to calculate trial length in ISO 8601 format (e.g., P365D to P1Y)
...
# Function to format age in ISO 8601 format
