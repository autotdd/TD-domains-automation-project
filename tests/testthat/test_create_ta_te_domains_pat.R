test_create_ta_te_domains <- function() {
  study_id <- "STUDY002"
  ...
  # Define TE rules
  te_rules <- data.frame(
    ELEMENT = c("SCREENING", "TREATMENT A", "TREATMENT B", "TREATMENT C", "TREATMENT D", "TREATMENT E", 
                "TREATMENT F", "TREATMENT G", "TREATMENT H", "TREATMENT I","FOLLOW-UP"),
    TESTRL = c("Informed consent", "First dose of study drug", "First dose of study drug", "First dose of study drug",
               "First dose of study drug", "First dose of study drug", "First dose of study drug", "First dose of study drug",
               "First dose of study drug", "First dose of study drug", "Start of follow-up"),
    TEENRL = c("End of screening", "End of treatment period", "End of treatment period", "End of treatment period",
               "End of treatment period", "End of treatment period", "End of treatment period", "End of treatment period",
               "End of treatment period", "End of treatment period", "End of follow-up"),
    TEDUR = c("P7D", "P14D", "P21D", "P28D", "P14D", "P21D", "P28D", "P14D", "P21D", "P28D", "P35D")
  )
